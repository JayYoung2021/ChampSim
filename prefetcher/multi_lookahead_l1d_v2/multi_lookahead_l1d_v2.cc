...
public:
  ...
  void set_state(uint64_t block_number, State new_state, int new_fill_level = 0)
  {
    ...
    // else
    //     assert(new_fill_level == static_cast<int>(DeprecatedFillLevel::FILL_L1) || new_fill_level == static_cast<int>(DeprecatedFillLevel::FILL_L2) ||
    //     new_fill_level == static_cast<int>(DeprecatedFillLevel::FILL_LLC));
